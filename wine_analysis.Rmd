...
- It looks like the `log(fixed.acidity)` and `log(volatile.acidity)` atleast are more bell-shaped than normal plots.  
...
- After log transformation `residual.sugar`, `sulphates` and `chlorides` looks in bell shape and normally distributed.
...
colnames(wine_tmp) = c("Fix.Ac", 
                       ...
                       "Alc",
                       "Quality")
suppressMessages(ggpairs(wine_tmp,  params=list(size=4,binwidth=5)) + 
